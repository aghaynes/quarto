...
$if(address_recipient_line1)$
  address_recipient_line1: "$address_recipient_line1$",
$endif$
$if(address_recipient_line2)$
  address_line2: "$address_recipient_line2$",
$endif$
$if(address_recipient_line3)$
  address_recipient_line3: "$address_recipient_line3$",
$endif$
$if(address_line4)$
  address_recipient_line4: "$address_recipient_line4$",
$endif$
$if(address_line5)$
  address_recipient_line5: "$address_recipient_line5$",
$endif$
$if(sender)$
  sender: "$sender$",
$endif$
