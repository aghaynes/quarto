This is a [quarto](https://quarto.org) html reporting template for sample size calculations at DCR.
...
```
quarto install extension dcr-unibe-ch/quarto@html-rec
```
...
```
quarto use template dcr-unibe-ch/quarto@html-rec
```
